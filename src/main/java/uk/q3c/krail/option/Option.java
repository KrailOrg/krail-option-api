 ...
 * <p>
 * * <b>NOTE:</b> All values to and from {@link Option} are natively typed.  All values to and from  OptionCache,  DefaultOptionCacheLoader and
 * OptionDaoDelegate are wrapped in Optional.
 * <p>
...
public interface Option {
     ...
     *
     * @param <T>       a type determined by the the default value from {@code optionKey} .  An implementation should assume that an object of any type can be passed.
     ...
     * @param hierarchyRank the hierarchy rank to assign the value to
     * @param optionKey     identifier for the option, in its context
     */
