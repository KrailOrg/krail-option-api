...
public class OptionDescriptor {
    ...
    /**
     * @param optionKey      the option key which defines the option within its context
     * @param descriptionKey a description key to look up the I18N description for the option
     * @param allQualifiers  if true the description applies to all optionKeys with the same context and key - in other words the qualifier element is ignored
     */
