...
/**
 * Provides data access to persistence for {@link OptionDaoDelegate}
 * <br>
...
public interface OptionDao extends Serializable {
     ...
     */
    <V> void write(OptionCacheKey<V> cacheKey, Optional<V> value);
    ...
    <V> Optional<V> getValue(OptionCacheKey<V> cacheKey);
