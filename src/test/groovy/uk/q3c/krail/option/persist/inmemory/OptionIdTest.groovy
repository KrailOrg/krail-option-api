...
package uk.q3c.krail.option.persist.inmemory
...
class OptionIdTest extends Specification {
    ...
    static enum LabelKey implements I18NKey {
        Yes
    }

    static enum DescriptionKey implements I18NKey {
        Account_Already_In_Use
    }

    static class SourcePanel implements OptionContext {
    ...
    OptionKey<Integer> optionKey = new OptionKey<>(33, MockOptionContext.class, LabelKey.Yes, DescriptionKey.Account_Already_In_Use, "a", "b")
    ...
    def "construct from CacheKey"() {
        ...
        then:
        id.getContext().equals(MockOptionContext.class.getName())
